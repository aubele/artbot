// ====================== line for input doesn't lose focus ==================
...
$(document).ready(function () {
	...
	user_id = "Fabio Aubele und Joshua Hoermann";

	//if you want the bot to start the conversation
	action_trigger();

	// open the chatbot widget immediately
	$( "#profile_div" ).click();
});
...
function action_trigger() {
    ...
    $.ajax({
		...
		data: JSON.stringify({ "name": action_name, "policy": "policy_1_KerasPolicy", "confidence": "0.98" }),
...
function setBotResponse(response) {
	...
	setTimeout(function () {
		...
		if (response.length < 1) {
			...
			var fallbackMsg = "Dafür hab ich leider keine Antwort, versuch doch eine andere Eingabe!";
